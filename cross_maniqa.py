...
def load_cross_dataset(config):
    train_dataset = TID2013(data_path=config.tid_path, label_path=config.tid_label)
    test_dataset = LIVEC(data_path=config.livec_path, label_path=config.livec_label)
...
if __name__ == '__main__':
    ...
    config = Config({
        # dataset path
        "dataset_name": "cross_dataset", # kadid10k, koniq10k, livec, tid2013, spaq, csiq
        ...
        "ckpt_path": "./output_spaq_wo_slic/models/",               # directory for saving checkpoint
        "log_path": "./output_spaq_wo_slic/log/",
        "log_file": ".log",
        "tensorboard_path": "./output_spaq_wo_slic/"
    })
    ...
    if config.dataset_name == 'kadid10k':
        ...
        Dataset = CSIQ
    elif config.dataset_name == 'cross_dataset':
        train_dataset, test_dataset = load_cross_dataset(config)
    else:
        pass
